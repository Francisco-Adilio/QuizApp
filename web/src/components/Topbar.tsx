...
export function Topbar() {
  ...
  return (
    <div className='w-full h-16 bg-violet-600 absolute z-10 flex px-4 items-center'>
      ...
      <a href='/create' className='absolute right-0 bg-green-600 h-12 w-40 mr-20 rounded-md text-lg font-semibold text-zinc-100 flex items-center justify-between px-4'>
        <Plus size={24}/>
        Create Quiz
      </a>
